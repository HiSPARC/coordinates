...
\secref{sec:celestial}. Finally in \secref{sec:corsika} the coordinate
systems are used in \corsika simulations are described.
...
conversion of celestial coordinates in \secref{sec:celestial}. The full
...
\begin{equation}
    \mathit{GMST} = 6.697374558 + 0.06570982441908\ D0 + 1.00273790935\ H +
                    0.000026\ T^2
\end{equation}
